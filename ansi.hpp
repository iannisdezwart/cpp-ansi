 ...
 */
inline void
cursor_down(size_t n)
{
	printf("\x1b[%luB", n);
}

/**
 * Moves the cursor forward a given number of columns.
 */
inline void
cursor_forward(size_t n)
{
	printf("\x1b[%luC", n);
}

/**
 * Moves the cursor backward a given number of columns.
 */
inline void
cursor_back(size_t n)
{
	printf("\x1b[%luD", n);
}
 ...
 * An offset can be given to move the cursor down a given number of lines.
 */
inline void
cursor_next_line(size_t n)
{
	printf("\x1b[%luE", n);
}
 ...
 * An offset can be given to move the cursor up a given number of lines.
 */
inline void
cursor_prev_line(size_t n)
{
	printf("\x1b[%luF", n);
}
...
/**
 * Scroll the whole page up by a given number of lines.
 */
inline void
scroll_up(size_t n)
{
...
/**
 * Scroll the whole page down by a given number of lines.
 */
inline void
